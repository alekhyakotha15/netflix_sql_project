...
where release_year=2019 and type='TV Show';
...
--13) Find the top 10 actors who have appeared in the highest number of movies 
...
--14) Finding each year and the average number of content release 
--by Canada on netflix ( return top 5 year with highest avg content release)
...
--15) Categorize Content Based on the Presence of 'Driver' and 'Violence' Keywords

...
- **The dataset contains content in diverse range of Movies and Tv shows with different types of genres and also ratings.
- **The top least content countries gives information about further decisions or regional content distribution.
- **Identifying top actors with most content helps Netflix to understand viewer Engagement or provide recommendations to users who frequently watch their content.

## This project is part of my Data Analysis practice and I have worked on this project alone by developing my own sql queries, but collected all the business questions and took guidance from Zero Analyst. 
